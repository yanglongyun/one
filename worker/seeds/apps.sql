    ...
    <div id="modal" class="modal-mask" style="display:none">
        <div class="modal">
            ...
            <div class="field" style="margin-top:12px">
                <label>颜色</label>
                <div class="row" id="f-colors" style="gap:10px;flex-wrap:wrap"></div>
            </div>
            <div class="pin-row">
...
:root {
    ...
    --paper-purple: #efe7fe; --paper-purple-deep: #8b5cf6;
    --paper-orange: #ffe8d1; --paper-orange-deep: #f97316;
    --paper-teal: #d4f5ef; --paper-teal-deep: #14b8a6;
    --paper-red: #fee2e2; --paper-red-deep: #ef4444;
    --paper-slate: #3f4c63; --paper-slate-deep: #7c8aa3;
    --paper-night: #2a3040; --paper-night-deep: #5a6782;
...
.note-orange { background: var(--paper-orange); }
.note-teal { background: var(--paper-teal); }
.note-red { background: var(--paper-red); }
.note-slate { background: var(--paper-slate); color: #eaf0fb; }
.note-night { background: var(--paper-night); color: #eaf0fb; }
/* 深色卡片:正文/时间改浅色保证对比 */
.note-slate .note-body, .note-night .note-body { color: #c6d1e4; }
.note-slate .note-foot .time, .note-night .note-foot .time { color: #97a6c1; }
...
.cdot-purple { background: var(--paper-purple); border-color: var(--paper-purple-deep); }
.cdot-orange { background: var(--paper-orange); border-color: var(--paper-orange-deep); }
.cdot-teal { background: var(--paper-teal); border-color: var(--paper-teal-deep); }
.cdot-red { background: var(--paper-red); border-color: var(--paper-red-deep); }
.cdot-slate { background: var(--paper-slate); border-color: var(--paper-slate-deep); }
.cdot-night { background: var(--paper-night); border-color: var(--paper-night-deep); }
